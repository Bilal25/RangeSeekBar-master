...
import static com.syedbilal.widget.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.syedbilal.widget.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    /**
     * @return the two seekBar state , see {@link com.syedbilal.widget.SeekBarState}
     */
    public SeekBarState[] getRangeSeekBarState() {
        SeekBarState leftSeekBarState = new SeekBarState();
        leftSeekBarState.value = leftSB.getProgress();

        leftSeekBarState.indicatorText = String.valueOf(Integer.valueOf((int) leftSeekBarState.value).intValue());
        ...
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            ...
            rightSeekBarState.indicatorText = String.valueOf(Integer.valueOf((int) rightSeekBarState.value).intValue());
